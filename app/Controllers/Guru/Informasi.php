...
class Informasi extends BaseController
{
    ...
    public function simpan_berita()
    {
        ...
        $model->insert($data);
        return redirect()->to(base_url('guru/informasi/berita'))->with('success', 'Berita berhasil ditambahkan');
    }
    ...
    public function update_berita($id)
    {
        ...
        return redirect()->to(base_url('guru/informasi/berita'))->with('success', 'Berita berhasil diperbarui');
    }
    ...
    public function hapus_berita($id)
    {
        ...
        $model->delete($id);
        return redirect()->to(base_url('guru/informasi/berita'))->with('success', 'Berita berhasil dihapus');
    }
    ...
    public function simpan_pengumuman()
    {
        ...
        $model->insert($data);
        return redirect()->to(base_url('guru/informasi/pengumuman'))->with('success', 'Pengumuman berhasil ditambahkan');
    }
    ...
    public function update_pengumuman($id)
    {
        ...
        $model->update($id, $data);
        return redirect()->to(base_url('guru/informasi/pengumuman'))->with('success', 'Pengumuman berhasil diperbarui');
    }
    ...
    public function hapus_pengumuman($id)
    {
        $model = new PengumumanModel();
        $model->delete($id);
        return redirect()->to(base_url('guru/informasi/pengumuman'))->with('success', 'Pengumuman berhasil dihapus');
    }
}