...
class Kepegawaian extends BaseController
{
    ...
    public function simpan_riwayat()
    {
        ...
        $model->insert($data);
        return redirect()->to(base_url('guru/kepegawaian/riwayat'))->with('success', 'Data Riwayat berhasil ditambahkan.');
    }
    ...
    public function update_riwayat($id)
    {
        ...
        return redirect()->to(base_url('guru/kepegawaian/riwayat'))->with('success', 'Data Riwayat berhasil diperbarui.');
    }
    ...
    public function hapus_riwayat($id)
    {
        $model = new PendidikanGuruModel();
        $model->delete($id);
        return redirect()->to(base_url('guru/kepegawaian/riwayat'))->with('success', 'Data Riwayat berhasil dihapus.');
    }
    ...
    public function simpan_sertifikasi()
    {
        ...
        $model->insert($data);
        return redirect()->to(base_url('guru/kepegawaian/sertifikasi'))->with('success', 'Data Sertifikasi berhasil ditambahkan.');
    }
    ...
    public function update_sertifikasi($id)
    {
        ...
        $model->update($id, $data);
        return redirect()->to(base_url('guru/kepegawaian/sertifikasi'))->with('success', 'Data Sertifikasi berhasil diperbarui.');
    }
    ...
    public function hapus_sertifikasi($id)
    {
        $model = new SertifikasiModel();
        $model->delete($id);
        return redirect()->to(base_url('guru/kepegawaian/sertifikasi'))->with('success', 'Data Sertifikasi berhasil dihapus.');
    }
