...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="modern-card bg-white p-4 h-100">
            ...
            <form action="<?= base_url('guru/kepegawaian/simpan_sertifikasi') ?>" method="post">
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary text-uppercase fs-7">Nama Sertifikasi</label>
                    <input type="text" class="form-control modern-input" name="nama_sertifikasi" placeholder="Sertifikat Pendidik" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control modern-input" name="keterangan" placeholder="Opsional">
                </div>
    ...
    <div class="col-lg-8">
        <div class="modern-card bg-white p-0 h-100 overflow-hidden">
            <div class="p-4 border-bottom border-light d-flex justify-content-between align-items-center bg-light">
                <h5 class="fw-bold m-0 text-dark"><i class="fas fa-medal me-2 text-warning"></i> Data Sertifikasi Keahlian Anda</h5>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('guru/kepegawaian/hapus_sertifikasi/' . $row['id_sertifikasi']) ?>" onclick="return confirm('Hapus sertifikasi ini?')" class="btn btn-sm btn-light text-danger rounded-circle shadow-sm d-inline-flex align-items-center justify-content-center hover-lift" style="width:35px; height:35px;"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
...
<div class="modal fade" id="modalEdit<?= $row['id_sertifikasi'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('guru/kepegawaian/update_sertifikasi/' . $row['id_sertifikasi']) ?>" method="post">
