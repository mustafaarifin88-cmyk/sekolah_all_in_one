                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('guru/akademik/hapus_nilai/' . $row['id_nilai']) ?>" class="btn btn-sm btn-light text-danger border rounded-pill px-3 shadow-sm" onclick="return confirm('Yakin ingin menghapus nilai ini?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
