...
<div class="row g-4">
    <div class="col-lg-4">
        <div class="modern-card bg-white p-4 h-100">
            ...
            <form action="<?= base_url('guru/kepegawaian/simpan_riwayat') ?>" method="post">
                <div class="mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('guru/kepegawaian/hapus_riwayat/' . $row['id_riwayat_pdd']) ?>" onclick="return confirm('Hapus riwayat ini?')" class="btn btn-sm btn-light text-danger rounded-circle shadow-sm d-inline-flex align-items-center justify-content-center hover-lift" style="width:35px; height:35px;"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
...
<div class="modal fade" id="modalEdit<?= $row['id_riwayat_pdd'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('guru/kepegawaian/update_riwayat/' . $row['id_riwayat_pdd']) ?>" method="post">
