...
<style>
    ...
    .upload-btn:hover { background: #11998e; color: #fff; transform: scale(1.1); }
    ...
    <div class="col-lg-8">
        <div class="profile-card pb-5">
            ...
            <div class="text-center mt-3 mb-5">
                <h4 class="fw-bold text-dark m-0"><?= $profil['username'] ?? 'User Siswa' ?></h4>
                <p class="text-muted fw-semibold mb-0"><i class="fas fa-user-graduate me-1 text-success"></i> Pelajar Aktif</p>
            </div>
                ...
                <form action="<?= base_url('siswa/profil/update') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-0 text-success px-3 rounded-start-3"><i class="fas fa-user"></i></span>
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted mt-2 d-block"><i class="fas fa-info-circle me-1"></i> Jaga kerahasiaan password Anda.</small>
                    </div>
