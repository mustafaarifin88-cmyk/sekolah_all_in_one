        ...
        <div class="modern-card p-4 mb-4" style="background: var(--theme-gradient);">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="text-white">
                    <h4 class="fw-bold mb-1"><i class="fas fa-certificate me-2"></i> Data Sertifikasi</h4>
                    <p class="mb-0 opacity-75 fs-7">Sertifikat pendidik atau keahlian yang dimiliki guru.</p>
                </div>
                ...
                <table class="table table-hover table-modern mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold" style="color: var(--theme-color);"><?= $row['nama_sertifikasi'] ?></td>
                            <td>
                                <span class="badge bg-light text-dark border px-2 py-1 mb-1">Tahun <?= $row['tahun'] ?></span><br>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('admin/kepegawaian/hapus_sertifikasi/' . $row['id_sertifikasi']) ?>" onclick="return confirm('Hapus sertifikasi ini?')" class="btn btn-sm btn-light text-danger rounded-circle shadow-sm d-inline-flex align-items-center justify-content-center hover-lift" style="width:35px; height:35px;"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr><td colspan="5" class="text-center py-5 text-muted"><i class="fas fa-medal fs-1 mb-3 opacity-50 d-block"></i>Belum ada data sertifikasi.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header modal-header-custom">
                <h5 class="modal-title fw-bold text-white"><i class="fas fa-plus-circle me-2"></i> Tambah Sertifikasi</h5>
            ...
            <form action="<?= base_url('admin/kepegawaian/simpan_sertifikasi') ?>" method="post">
                <div class="modal-body p-4 bg-white">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control modern-input" name="nama_sertifikasi" placeholder="Ex: Sertifikasi Pendidik" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold text-secondary text-uppercase fs-7">Keterangan</label>
                        <input type="text" class="form-control modern-input" name="keterangan" placeholder="Penyelenggara / Nomor Seri">
                    </div>
                </div>
...
<div class="modal fade" id="modalEdit<?= $row['id_sertifikasi'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header modal-header-custom">
                <h5 class="modal-title fw-bold text-white"><i class="fas fa-edit me-2"></i> Edit Sertifikasi</h5>
                <button type="button" class="close text-white shadow-none" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <form action="<?= base_url('admin/kepegawaian/update_sertifikasi/' . $row['id_sertifikasi']) ?>" method="post">
                <div class="modal-body p-4 bg-white">
                    <div class="mb-3">
                        <label class="form-label fw-bold text-secondary text-uppercase fs-7">Pilih Guru/Tendik</label>
                        <select name="id_guru" class="form-control modern-input" required>
