    ...
    <div class="col-lg-4">
        <div class="modern-card bg-white p-4 h-100 border">
            <div class="d-flex align-items-center mb-4">
                ...
                <h5 class="fw-bold m-0 text-dark">Tambah Riwayat</h5>
            </div>
            <form action="<?= base_url('walikelas/kepegawaian/simpan_riwayat') ?>" method="post">
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary text-uppercase fs-7">Asal Sekolah/Kampus</label>
                    <input type="text" class="form-control modern-input" name="asal_sekolah" required>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary text-uppercase fs-7">Jurusan (Opsional)</label>
                    <input type="text" class="form-control modern-input" name="jurusan">
                </div>
                <div class="mb-4">
    ...
    <div class="col-lg-8">
        <div class="modern-card bg-white p-0 h-100 overflow-hidden border">
            <div class="p-4 border-bottom border-light bg-light">
                <h5 class="fw-bold m-0 text-dark"><i class="fas fa-history me-2 text-primary"></i> Data Riwayat Pendidikan Pribadi</h5>
            </div>
                ...
                <table class="table table-hover table-modern mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-primary fs-6"><?= $row['asal_sekolah'] ?></td>
                            <td>
                                <span class="fw-semibold text-dark"><?= $row['jurusan'] ?: '-' ?></span><br>
                                <span class="badge bg-light text-secondary border px-2 py-1 mt-1">Lulus: <?= $row['tahun_lulus'] ?></span>
                            </td>
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('walikelas/kepegawaian/hapus_riwayat/' . $row['id_riwayat_pdd']) ?>" onclick="return confirm('Hapus riwayat ini?')" class="btn btn-sm btn-light text-danger rounded-circle shadow-sm d-inline-flex align-items-center justify-content-center hover-lift" style="width:35px; height:35px;"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr><td colspan="4" class="text-center py-5 text-muted"><i class="fas fa-user-graduate fs-1 mb-3 opacity-50 d-block"></i>Belum ada data yang ditambahkan.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<div class="modal fade" id="modalEdit<?= $row['id_riwayat_pdd'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('walikelas/kepegawaian/update_riwayat/' . $row['id_riwayat_pdd']) ?>" method="post">
                <div class="modal-body p-4 bg-white">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold text-secondary text-uppercase fs-7">Jurusan</label>
