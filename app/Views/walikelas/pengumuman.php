...
<div class="row">
    <div class="col-12">
        <div class="modern-card p-4 mb-4" style="background: var(--theme-gradient);">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="text-dark">
                    ...
                    <p class="mb-0 opacity-75 fs-7 text-dark fw-semibold">Kelola informasi publik yang Anda bagikan kepada siswa.</p>
                </div>
        ...
        <div class="modern-card bg-white p-0 overflow-hidden border">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('walikelas/informasi/hapus_pengumuman/' . $row['id_pengumuman']) ?>" onclick="return confirm('Hapus pengumuman ini?')" class="btn btn-sm btn-light text-danger rounded-circle shadow-sm d-inline-flex align-items-center justify-content-center hover-lift" style="width:35px; height:35px;"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
...
<div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('walikelas/informasi/simpan_pengumuman') ?>" method="post">
...
<div class="modal fade" id="modalEdit<?= $row['id_pengumuman'] ?>" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('walikelas/informasi/update_pengumuman/' . $row['id_pengumuman']) ?>" method="post">
                <div class="modal-body p-4 bg-light modal-body-scroll">
                    <div class="bg-white p-4 rounded-4 shadow-sm border border-light h-100">
                        <div class="mb-4">
                            <label class="form-label fw-bold text-secondary text-uppercase fs-7">Judul Pengumuman</label>
...
<script>
    window.addEventListener("load", function() {
        $('.summernote').summernote({ height: 300, toolbar: [['style', ['bold', 'italic', 'underline']], ['para', ['ul', 'ol']]] });
    });
</script>
<?= $this->endSection() ?>