...
$routes->group('admin', static function ($routes) {
    ...
    $routes->group('aplikasi', static function ($routes) {
        ...
        $routes->post('update_set_kelas/(:num)', 'Admin\Aplikasi::update_set_kelas/$1');
        ...
        $routes->post('update_set_mapel/(:num)', 'Admin\Aplikasi::update_set_mapel/$1');
    ...
    $routes->group('kelulusan', static function ($routes) {
        ...
        $routes->get('hapus_setting/(:num)', 'Admin\Kelulusan::hapus_setting/$1');
...
$routes->group('guru', static function ($routes) {
    ...
    $routes->group('akademik', static function ($routes) {
        ...
        $routes->get('data_siswa', 'Guru\Akademik::data_siswa');
        $routes->get('data_siswa/(:any)', 'Guru\Akademik::data_siswa/$1');
...
$routes->group('walikelas', static function ($routes) {
...
$routes->group('siswa', static function ($routes) {
    ...
    $routes->get('rapor/cetak_rapor', 'Siswa\Rapor::cetak_rapor');
});